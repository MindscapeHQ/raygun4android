 ...
 *
 * <p>You should call init() on the static RaygunClient instance, passing in the application,
...
public class RaygunClient {
    ...
    /**
     * Initializes the Raygun client with your Android application and your Raygun API key. The
     ...
     *
     * <p>This method is intended to be used by 3rd-party libraries such as Raygun for React Native
     ...
     *
     * <p>If you use an email address to identify the user, please consider using
     ...
     *
     * <p>The default and maximum value for this is 64. We do not recommend to change this setting
     * unless you have a very good reason and use case.
     *
     * <p>If you decrease the value of maxReportsStoredOnDevice, all currently cached reports will
     * be deleted.
     *
     ...
     * Network logging will be enabled for RUM by default.
     *
